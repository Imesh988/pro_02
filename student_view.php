...
<div class="col-12 mt-2">
    <div class="card p-2">
        <h1 class="card-title mx-2">STUDENT VIEW</h1>
        <div class="P-2">
        <table class="table">
        ...
        if ($result->num_rows > 0){
            while ($row = $result->fetch_assoc()) {
                echo "<tr>
                        ...
                        <td>
                          <a href='update_student.php?st_id=" . $row['st_id'] ." ' class='btn btn-success'>Update</a>
                          <a href='delete_student.php?st_id=" . $row['st_id'] ." ' class='btn btn-danger'>Delect</a>
                        </td>
                    </tr>";
            }
        }
